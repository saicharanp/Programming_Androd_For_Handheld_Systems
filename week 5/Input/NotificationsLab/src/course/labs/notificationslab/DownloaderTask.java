				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
                            ...
                            notificationBuilder=new Notification.Builder(mApplicationContext).setContentIntent(pendingIntent).setContentTitle("TWEETS").setContentText("DOWNLOAD COMPLETED").setAutoCancel(true).setSmallIcon(android.R.drawable.stat_sys_warning);
